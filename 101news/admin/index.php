...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Health Media Network | Admin Panel</title>
            ...
            <div class="container m-t-50">
                <div class="row align-items-center m-t-50">
                    <div class="col-md-8 text-center">
                        <img src="assets/images/blog.jpeg" width="auto">
                    </div>
                    <div class="col-md-4 ">
                                ...
                                <div class="account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.php" class="text-success">
                                            <span><img src="assets/images/logo health-01.svg" alt="" width="350px"></span>
                                        </a>
                                    </h2>
