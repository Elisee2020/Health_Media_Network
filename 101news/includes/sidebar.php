...
<!-- <h4 class="widget-title mb-5">Don't <span>Miss</span></h4> -->
   ...
   <div class="card mb-4 border-0">
      <h5 class="card-header border-0 bg-white" style="color: #26adfc;">Search</h5>
      <div class="card-body">
   ...
   <div class="card my-4 border-0">
      <h5 class="card-header border-0 bg-white" style="color: #26adfc;">Recent News</h5>
      <div class="card-body">
   ...
   <!-- Side Widget -->
   <div class="card my-4 border-0">
      <h5 class="card-header border-0 bg-white" style="color: #26adfc;">Popular  News</h5>
      <div class="card-body">
   ...
   <!-- Side Widget -->
   <div class="card my-4 border-0">
      <h5 class="card-header border-0 bg-white" style="color: #26adfc;">Top Trending</h5>
      <div class="card-body">
         <ul class="mb-0 list-unstyled">
            <?php
               $query=mysqli_query($con,"select tblposts.id as pid,tblposts.PostImage,tblposts.PostTitle as posttitle from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId limit 8");
   ...
   <h5 class="card-header border-0 bg-transparent" style="color: #26adfc;">Most Popular</h5>
   <div class="card my-4 border-0">
      <div class="card-body p-2">
        <iframe width="100%" height="180px" class="youtube" src="https://www.youtube.com/@WHOAfricanRegion" title="Sample Videos / Dummy Videos For Demo Use" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </div>
   </div>
   <div class="card my-4 border-0">
      <div class="card-body p-2">
